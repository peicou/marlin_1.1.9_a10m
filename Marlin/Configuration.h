...
#define STRING_CONFIG_H_AUTHOR "(Geetech team + Arif, A10M config)" // Who made the changes.
...
#define HOTEND_OFFSET_X {0.0, 20.0} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 122.92   // 175.68 189.95
  #define  DEFAULT_bedKi 20.28    //  34.59  37.40
  #define  DEFAULT_bedKd 186.29   // 223.07 241.19
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.9, 403, 425, 438 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 400, 40, 40 } //Orig { 300, 300, 5, 25 } //1.0.3 { 300, 300,20, 25 }
...
// Arif hack: Tilt compensation
//#define TILT_COMPENSATION
#if ENABLED(TILT_COMPENSATION)
   #define X_TILT_COMP 0 // lower value - left bed edge higher
   #define Y_TILT_COMP 0 // - front bed edge higher
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 3, 3, 10 } //{ (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 }
