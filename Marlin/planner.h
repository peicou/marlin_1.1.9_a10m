...
class Planner {
  public:
    ...
    static int16_t flow_percentage[E_STEPPERS];      // Extrusion factor for each extruder

    static float e_factor[E_STEPPERS];               // The flow percentage and volumetric multiplier combine to scale E movement
